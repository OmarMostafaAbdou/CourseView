...
//                             <p className="card-title" style={{ color: '#252641', fontSize: '26px',marginTop:'20px'}}>Become a Teacher</p>
                ...
                <div className='cards'>
                    ...
                    <div className="card col-6" >
                        ...
                        <div className="card-body">
                            ...
                            <button className="btn" style={{backgroundColor:'#49BBBD',color:'white',margin:'35px 20px 25px 450px'}} onClick={handleTeacherApply}>
                                Apply a Teacher
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="card col-6" >
                        ...
                        <div className="card-body">
                            ...
                            <button className="btn" style={{backgroundColor:'#49BBBD',color:'white', margin:'35px 20px 25px 450px'}} onClick={handleCoursectorApply}>
                                Apply a Coursector
                            </button>
                        </div>
                    </div>
