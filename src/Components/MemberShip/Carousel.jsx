...
//                 <div className="row row-col-4" style={{gap:'20px',display:'flex',flexDirection:'row-reverse',flexWrap:'wrap'}}>
...
//               data-bs-slide="prev"
//               style={{width:'50px',height:'50px',borderRadius:'50%',backgroundColor:'#49BBBD',zIndex:'auto',margin:'170px -20px'}}
//             >
