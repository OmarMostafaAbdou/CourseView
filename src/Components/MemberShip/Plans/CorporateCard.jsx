...
//   <p style={{ color: "#49BBBD", fontSize: "18px" ,fontWeight:"bold" }}>Corporate</p>
//   <div><span style={{ color: "#2D3436", fontSize: "48px" ,fontWeight:"bold" }}>$12 </span> <span style={{ color: "#2D3436", fontSize: "12px" ,fontWeight:"bold" }}> / EDITOR</span></div>
...
function CorporateCard() {
    ...
    const fetchCorporatePlanData = async () => {
        try {
            const response = await axiosInstance.get('http://localhost:4000/membership/corporate');
    ...
    return (
        <div className="itemCard">
            <p style={{ color: "#49BBBD", fontSize: "18px", fontWeight: "bold" }}>Corporate</p>
            <div>
                <span style={{ color: "#2D3436", fontSize: "48px", fontWeight: "bold" }}>${corporatePlanData.price} </span>
                <span style={{ color: "#2D3436", fontSize: "12px", fontWeight: "bold" }}> / {corporatePlanData.duration}</span>
            </div>
            <ul>
                {corporatePlanData.benefits && corporatePlanData.benefits.map((benefit, index) => (
